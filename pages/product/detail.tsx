...
import { GET_PROPERTIES, GET_PRODUCT } from '../../apollo/user/query';
...
const ProductDetail: NextPage = ({ initialComment, ...props }: any) => {
	...
	if (getPorpertyLoading) {
		return (<Stack sx={{display: "flex", justifyContent: "center", width: '100%', height: '1080px'}}>
